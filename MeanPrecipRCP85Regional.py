...
# Load the CSV file
file_path = "/users/shaanpatel/desktop/Data 2/12km/MeanPrecipRCP85Regional.csv"
...
plt.title('Mean Precipitation Rate for Different Models', fontsize=16)
...
plt.title('Annual Mean Precipitation Rate across London from 1981-2080 using Regional Models')

# Move the legend outside the plot area
plt.legend(fontsize=7, bbox_to_anchor=(1.05, 1), loc='upper left')
plt.xticks(np.arange(1981, 2090, 10), rotation='vertical', fontsize=5)
plt.show()
