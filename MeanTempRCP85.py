...
##This script is used to analyse the temperature data from the (60km) regional models used in the UKCP18 projections. RCP8.5

import pandas as pd
import matplotlib.pyplot as plt

# File path and name
file_path = '/users/shaanpatel/Desktop/Data 2/60km/MeanTempRCP26.csv'
